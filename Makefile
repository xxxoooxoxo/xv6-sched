...
CFLAGS = -fno-pic -static -fno-builtin -fno-strict-aliasing -Og -MD -ggdb -m32 -fno-omit-frame-pointer -fno-delete-null-pointer-checks -std=gnu99
...
EXTRA=\
	...
	printf.c umalloc.c writecount.c\
